...
%	\end{figure}
	...
	W celu znalezienia rzędu medelu skorzystaliśmy z kryterium iinformacyjnego Akkaike. Jest to metoda największej wiargodności z karą dla danego $p$ i $q$ w postaci
	\begin{equation}
